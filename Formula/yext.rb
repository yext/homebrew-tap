...
class Yext < Formula
  ...
  url "https://yext-cli-pub.s3.amazonaws.com/cli/mac/yext-0af1b5817d168fddf746c2c46927998d"
  version "0.1"
  sha256 "0bc9b1fffbcf493b01877abe7f231d8f6e00ba92270d11dd7b0a2d44f0fcd65a"
  revision 404

  def install
    mv "yext-0af1b5817d168fddf746c2c46927998d", "yext"
    bin.install "yext"
