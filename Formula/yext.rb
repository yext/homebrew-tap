...
class Yext < Formula
  ...
  url "https://yext-cli-pub.s3.amazonaws.com/cli/mac/yext-66684f8c3d799b1a3db1db146efa6a0b"
  version "0.1"
  sha256 "5e4764a19cbf0b9476f43012c0fc74e441db8fd6ad015e9a70f553b785a33cf2"
  revision 86

  def install
    mv "yext-66684f8c3d799b1a3db1db146efa6a0b", "yext"
    bin.install "yext"
